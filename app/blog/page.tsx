...
export default function Blog() {
  const posts = [
    ...
    },
    {
      ...
      excerpt: "Our first community town hall exceeded all expectations. Here is what happened and what comes next.",
    ...
    },
    {
      ...
      excerpt: "We spoke with three family farmers about what this bill means for them and why they are not backing down.",
